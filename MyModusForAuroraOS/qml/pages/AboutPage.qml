    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Label {
                ...
                textFormat: Text.RichText
                wrapMode: Text.WordWrap
                text: qsTr("<p><em>Copyright (c) © 2025 My Modus.</em></p>")
            }
        }
    }
}
