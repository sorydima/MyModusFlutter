...
class LamodaScraper extends BaseScraper {
  ...
  Future<List<Product>> _scrapeProducts() async {
    ...
    try {
      ...
      await driver.get('$baseUrl/c/muzhskaya_obuv/');
  ...
  Future<List<String>> _extractProductLinks(selenium.WebDriver driver) async {
    ...
    try {
      ...
      final productElements = await driver.findElementsByCss('.products-list-item__link');
  ...
  Future<Product?> _scrapeProductPage(selenium.WebDriver driver, String productUrl) async {
    try {
      ...
      return Product(
        ...
        brand: brand,
        category: 'Обувь', // TODO: Implement category detection
  ...
  String _extractImageUrl(parser.Document document) {
    try {
      final imageElement = document.querySelector('.product-gallery__image');
  ...
  String _extractDescription(parser.Document document) {
    try {
      final descriptionElement = document.querySelector('.product-description__text');
